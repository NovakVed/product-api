...
public class CurrencyConstants {
    ...
    public static final String ERROR_EXCHANGE_RATE_NOT_FOUND = "error.exchange.rate.not.found";
    public static final String ERROR_INVALID_EXCHANGE_RATE_DATA = "error.invalid.exchange.rate.data";
